export default function Paginacion(props: PaginacionProps) {
    ...
    const paginas = [];
    const cantidadMaximaPainasMostrar = 5;
    const totalPaginas = Math.ceil(props.cantidadTotalDeRegistros / props.registrosPorPagina);
    const radio = Math.floor(cantidadMaximaPainasMostrar / 2);
                ...
                <div className="row align-items-start justify-content-center">
                    <div className="col-auto">
                        <div className="d-flex align-items-center gap-2">
                            <label className="mb-0">Registro por página</label>
                            <select
                    ...
                    <div className="col">
                        <ul className="pagination justify-content-center mb-0">
                            <li className={`page-item ${props.paginaActual === 1 ? 'disabled' : ''}`}>
                                <button className="page-link" onClick={() => props.onCambioPaginacion
                                    (props.paginaActual - 1, props.registrosPorPagina)}>&laquo;</button>
                            </li>
                            ...
                            <li className={`page-item ${props.paginaActual === totalPaginas ? 'disabled' : ''}`}>
                                <button className="page-link" onClick={() => props.onCambioPaginacion
                                    (props.paginaActual + 1, props.registrosPorPagina)}>&raquo;</button>
                            </li>
