...
export default function IndiceEntidades<T>(props: IndiceEntidadesProps<T>) {
    ...
    return (
        <>
            ...
            {props.cargando ? <Cargando /> : <div className="mt-4">

                <div className="mb-2">
                    <Paginacion paginaActual={props.pagina} registrosPorPagina={props.recordsPorPagina} cantidadTotalDeRegistros={props.cantidadTotalRegistros}
