        ...
        <>
            <form onSubmit={handleSubmit(props.onSubmit)}>
                <div className="form-group">
                    ...
                    <input type="text" id="nombre" autoComplete="offf" className="form-control" 
                    {...register("nombre")} />
                ...
                <div className="form-group">
                    ...
                    <input type="date" id="fechaNacimiento" autoComplete="offf" className="form-control" 
                    {...register("fechaNacimiento")} />
                    {errors.fechaNacimiento && <p className="error">{errors.fechaNacimiento.message}</p>}
                </div>

                <SeleccionarImagen label="Foto" imageURL={imagenActualURL} imagenSeleccionada={foto => setValue("foto", foto)}/>
