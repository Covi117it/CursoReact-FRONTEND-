...
export default function FiltrarPeliculas() {
    ...
    return (
        <>
            ...
            className="row row-cols-lg-auto g-3 aling-items-center">
                ...
                <div className="col-12">
                    <Boton disabled={isSubmitting} type="submit">{isSubmitting ? "Flitrando..." : "Filtrar"}</Boton>
